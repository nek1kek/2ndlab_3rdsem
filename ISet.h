...
class ISet : protected RBTree<_Key, _Key, MultiSet, _cmp> {//если публичное, то остается все теми же уровнями функциями, если приватное, тогда все публичные стали приватные, 
protected:
...
public:
	...
	/*
	Пример того как можно брать в случае наследования переменные
	void Get123() {
